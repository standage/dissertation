...
\begin{figure}[!htb]
\centering
\includegraphics[height=6.5in]{Assets/Graphics/Pdom/figure-1}
...
\subsection*{Figure \ref{Fig:Pdom1} continued.}
\noindent
...
\begin{figure}
\centering
\includegraphics[height=8in]{Assets/Graphics/Pdom/figure-2}
\caption{(Caption on the following page.)}
\label{Fig:Pdom2}
\end{figure}

\FloatBarrier
\subsection*{Figure \ref{Fig:Pdom2} continued.}
\noindent
...
\FloatBarrier
\subsection*{Figure \ref{Fig:Pdom3} continued.}
\noindent
